...
import { useAdmin } from "./features/shared/hooks/use_admin";
...
export default function RootLayout({
  ...
  const menuItems: { name: string; href: string; icon: LucideIcon }[] = [
    ...
    { name: "정산 관리", href: "/global/billing/settlement/driver", icon: WalletCards },
                ...
                return (
                  <li key={item.href}>
                    ...
                    >
                      ...
                      <span className="flex-1 text-[15px] font-bold">{item.name}</span>
                      {isActive ? (
